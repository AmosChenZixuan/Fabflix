...
function handelMovieList(resultData){
    ...
    for (let i = 0; i < Math.min(resultData["movie_limit"]["movie_limit"], movieList.length); i++) {
        ...
        rowHTML += "<div class=\"col-4 mt-1 ml-1 my_col align-item-start\" style=\"background-image: url('" + pic_url + "')\">";
        rowHTML += "</div>";
        ...
        rowHTML += "<div class = \"col-3 my_col movie_genres \" ><div><b>Genres:</b> </div>" + "<div>"+genre_link(movieList[i]["movie_genre"],movieList[i]["movie_id"]) + "</div></div>";
        rowHTML += "<div class = \"col-4 my_col\"><div><b>Actors:</b></div>";
